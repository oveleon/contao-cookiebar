...
(
	...
	(
        ...
        'googleConsentMode'           => '{title_legend},title,type,token,showTokens,expireTime,showExpireTime,provider,showProvider;{google_consent_mode_legend},globalConfig;sourceUrl,sourceLoadingMode,sourceUrlParameter,sourceVersioning;gcmMode,vendorId,scriptConfig;{description_legend:hide},description,detailDescription;published,checked;',
